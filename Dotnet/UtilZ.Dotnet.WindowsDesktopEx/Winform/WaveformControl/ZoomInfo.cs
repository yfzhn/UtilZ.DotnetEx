...
namespace UtilZ.Dotnet.WindowsDesktopEx.Winform.WaveformControl
{
    internal class ZoomInfo
    {
        ...
        internal void ZoomIn(VoicePlotData plotPara, uint minPointCount = 5)
        {
            if (plotPara.ResampleTotalCount / this._zoomMultiple <= minPointCount)
            {
                return;
            }
        ...
        /// 缩小
        /// </summary>
        internal void ZoomOut(VoicePlotData plotPara)
        {
        ...
        private void UpdatePlotPara(VoicePlotData plotPara)
        {
