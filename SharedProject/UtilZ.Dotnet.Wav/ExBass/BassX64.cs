...
namespace UtilZ.Dotnet.Wav.ExBass
{
    ...
    internal class BassX64
    {
        ...
        [DllImport(@"x64\bass.dll", EntryPoint = "BASS_GetDeviceInfo")]
        ...
        /// <returns></returns>
        [DllImport(@"x64\bass.dll", CharSet = CharSet.Unicode)]
        ...
        /// <param name="option"></param>
        /// <returns></returns>
        [DllImportAttribute(@"x64\bass.dll", CharSet = CharSet.Unicode)]
        ...
        /// <returns>If successful, TRUE is returned, else FALSE is returned. Use BASS_ErrorGetCode to get the error code</returns>
        [return: MarshalAs(UnmanagedType.Bool)]
        [DllImport(@"x64\bass.dll", EntryPoint = "BASS_ChannelGetInfo")]
        ...
        /// <param name="flags"></param>
        /// <returns></returns>
        [DllImport(@"x64\bass.dll", EntryPoint = "BASS_StreamCreateFile")]
        ...
        /// <returns></returns>
        [DllImport(@"x64\bass.dll", EntryPoint = "BASS_StreamCreateURL")]
