...
namespace UtilZ.Dotnet.WindowsDesktopEx.Winform.Controls.PartAsynWait.Excute.Winform.V2
{
    ...
    internal class WinformPartAsynExcute2<T, TContainer, TResult> : WinformPartAsynExcuteBase<T, TContainer, TResult> where TContainer : class
    {
        /// <summary>
        /// 静态构造函数
        /// </summary>
        static WinformPartAsynExcute2()
        {
            _shadeType = typeof(UCMetroShadeControl2);
        }
