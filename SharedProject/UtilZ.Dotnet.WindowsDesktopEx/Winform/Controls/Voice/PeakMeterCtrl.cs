...
namespace UtilZ.Dotnet.WindowsDesktopEx.Winform.Controls
{
    ...
    public partial class PeakMeterCtrl : Control
    {
        ...
        {
            this._AnimDelay = Timeout.Infinite;
            this._MinRangeValue = MinRangeDefault; // [0,60[
            this._MedRangeValue = MedRangeDefault; // [60,80[
            this._MaxRangeValue = MaxRangeDefault; // [80,100[
            this._meterData = null;
            this._animationTimer = null;
            this._ShowGrid = true;
            this._ColoredGrid = false;
            this._GridColor = Color.Gainsboro;
            this._ColorNormal = Color.Green;
            this._ColorMedium = Color.Yellow;
            this._ColorHigh = Color.Red;
            this._ColorNormalBack = LightenColor(_ColorNormal, LightenByDefault);
            this._ColorMediumBack = LightenColor(_ColorMedium, LightenByDefault);
            this._ColorHighBack = LightenColor(_ColorHigh, LightenByDefault);
            this._BandsCount = BandsDefault;
            this._LEDCount = LEDDefault;
            this._FalloffSpeed = FalloffNormal;
            this._FalloffEffect = true;
            this._FalloffColor = DarkenColor(_GridColor, DarkenByDefault);
            this.ResetControl();
        }
